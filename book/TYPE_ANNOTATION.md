## Forked Mainly from 
https://github.com/microsoft/TypeScript-Website/blob/v2/packages/documentation/copy/en/javascript/JSDoc%20Reference.md
...
You can specify array types using a constiety of syntaxes:
...
```js twoslash
// Parameters may be declared in a constiety of syntactic forms
/**
...
/**
 * As do jsdocs on constiable assignments
 * @return {Window}
 */
 ...
 */
const fc = (props) => <div>{props.a.charAt(0)}</div>;
